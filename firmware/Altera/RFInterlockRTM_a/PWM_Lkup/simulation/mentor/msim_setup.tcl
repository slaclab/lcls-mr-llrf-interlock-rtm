...
# ----------------------------------------
# If PWM_Lkup is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2019.06.17.11:36:50
...
if ![ string match "*ModelSim ALTERA*" [ vsim -version ] ] {
  ...
  ensure_lib                  ./libraries/maxv/            
  vmap       maxv             ./libraries/maxv/            
}
ensure_lib                ./libraries/ufm_parallel_0/
vmap       ufm_parallel_0 ./libraries/ufm_parallel_0/
...
alias dev_com {
  ...
  if ![ string match "*ModelSim ALTERA*" [ vsim -version ] ] {
    ...
    eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QUARTUS_INSTALL_DIR/eda/sim_lib/maxv_atoms.v"                     -work maxv_ver        
    ...
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/maxv_atoms.vhd"                   -work maxv            
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/maxv_components.vhd"              -work maxv            
  }
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/PWM_Lkup_ufm_parallel_0.v" -work ufm_parallel_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/PWM_Lkup.vhd"                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ufm_parallel_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L maxv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L maxv $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L ufm_parallel_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L maxv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L maxv $TOP_LEVEL_NAME
}
