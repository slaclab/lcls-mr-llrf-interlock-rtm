...
wave add   cal_trig Cal_done Trig trig_sel trig_out
...
divider add "Cal_seq" -color red
wave add {/bpm_atest/uut/u_cal_seq/}

 
isim force add Clk119Mhz 0 -value 1 -time 5ns -repeat 10ns
#isim force add Trig 1 -value 0 -time 1us -repeat 2.777ms
...
isim force add rden 0
isim force add ain 0 -radix hex
isim force add din 2 -radix hex
